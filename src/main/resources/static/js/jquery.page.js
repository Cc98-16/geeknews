...
(function ($) {
  ...
  $.fn.Page = function (options) {
    ...
    return this.each(function () {
      ...
      var str = '';
      var str1 = '<li><a href="?page=1" class="'+ active +'">1</a></li>';
      if (l > 1&&l < n+1) {
        for (i = 2; i < l + 1; i++) {
      ...
      obj.on('click', 'li', function(){
        ...
        function fpageShow(activePage){
          ...
          var str1 = '';
          for(i=0;i<n;i++){
            str1 += '<li><a href="?page='+(pageStart+i)+'" class="">' + (pageStart+i) + '</a></li>'
          }
        ...
        function fpagePrv(index){
          ...
          if(l>n-1){
            for(i=0;i<n;i++){
              str1 += '<li><a href="?page='+(i+1)+'" class="">' + (i+1) + '</a></li>'
            }
          }else{
            for(i=0;i<l;i++){
              str1 += '<li><a href="?page='+(i+1)+'" class="">' + (i+1) + '</a></li>'
        ...
        function fpageNext(index){
          ...
          if(l>n-1){
            for(i=l-(n-1);i<l+1;i++){
              str1 += '<li><a href="?page='+i+'" class="">' + i + '</a></li>'
            }
           obj.find('ul').html(str1);
           obj.find('ul li').eq(index).find('a').addClass(active);
          }else{
